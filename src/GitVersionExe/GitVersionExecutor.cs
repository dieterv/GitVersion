...
namespace GitVersion
{
    public class GitVersionExecutor : IGitVersionExecutor
    {
        ...
        private readonly IFileLocker fileLocker;
        ...
        public GitVersionExecutor(ILog log, IConsole console,
            ...
            IVersionWriter versionWriter, IHelpWriter helpWriter, IGitRepositoryInfo repositoryInfo, IFileLocker fileLocker)
        {
            ...
            this.fileLocker = fileLocker ?? throw new ArgumentException(nameof(fileLocker));
        }
        ...
        {
            using (fileLocker.WaitUntilAcquired())
            {
                try
                {
